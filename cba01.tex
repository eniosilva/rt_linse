...
%\end{figure}
Dessa forma, as $B$ bandas de frequência correspondem a um ponto crucial para a construão dos descritores que compõem os vetores de observação MFCCs. Assim, os compenentes espectrais, ou seja, a resolução em frequecia é diretamente proporcional a qualidade dos descritores MFCCs. Então, quanto mais informações discriminativas, mais rico será o vertor de observação MFCC. A Fig.~\ref{FigBancoFiltro} ilustra a distribuição dos filtros triangulares no dominio da frequencia para espectros de sianis WB e NB.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%ESTOU AQUI NA REVISAO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Por apresentarem uma maior faixa de frequência, sinais WB possuem uma quantidade maior de descritores na análise MFCC quando comparados à sinais NB. Entretanto, os sinais NB provenientes da PSTN podem ser realçados através do sistema de ABWE que possibilita a estimação e a sí1nteze dos componentes de frequência discriminativas capazes de preencher todos os filtros triangulares dispostos na escala mel, exemplificado na Figura~\ref{FigBancoFiltro}.
