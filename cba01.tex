...
Por apresentarem uma maior faixa de frequência, sinais WB possuem uma quantidade maior de descritores na análise MFCC quando comparados à sinais NB. Entretanto, os sinais NB provenientes da PSTN podem ser realçados através do sistema de ABWE que possibilita a estimação e a sí1nteze dos componentes de frequência discriminativas capazes de preencher todos os filtros $H(k)$ dispostos na escala mel, exemplificado na Figura~\ref{FigBancoFiltro}.
