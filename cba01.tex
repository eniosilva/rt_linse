...
O objetivo de um sistema de ABWE é realçar o sinal de fala NB, aprimorando sua qualidade e fazendo com que esse sinal se assemelhe à um sinal WB. Isso é possível através da estimação dos componentes de frequências acima de $3.4$ kHz. A idéia básica de um sistema de ABWE é recriar artificialmente componentes de alta frequência, convertendo um sinal NB em um sinal WB, isto é, restaurando as propriedades acústicas pertinentes a WB~\cite{EnioSBrT2013}.
