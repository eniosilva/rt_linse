...
\section{\textcolor{red}{Revisão/Fundamentos} em reconhecimento automático de fala}
\label{backgroundASR}
\textcolor{blue}{O objetivo de um sistema de ASR é estimar satisfatoriamente as informações contidas em um sinal de fala. Geralmente o procedimento intermediário desse sistema é a conversão do sinal de fala em texto. Esta seção apresenta uma breve introdução \textcolor{red}{a sistemas/aos fundamentos} de ASR.}
...
\textcolor{blue}{Um sistema típico de ASR é composto por cinco blocos principais}: \textit{front-end}, dicionário fonético, modelo acústico, modelo de linguagem e decodificador, sendo que os quatro últimos blocos compõem uma estrutura usualmente chamada \textit{back-end}, conforme indicado na Fig.~\ref{asr01}. 
...
\section{\textcolor{red}{Revisão/Fundamentos} em extensão artificial de largura de banda}
...
O objetivo de um sistema de ABWE é realçar o sinal de fala NB, \textcolor{red}{tornando-o mais agradável aos ouvintes e fazendo com que sua qualidade subjetiva se \textcolor{red}{assemelhe} à um sinal WB}. Isso é possível através da estimação dos componentes de frequências acima de $3.4$ kHz. Assim, a idéia básica de um sistema de ABWE é \textcolor{red}{sintetizar} artificialmente componentes de alta frequência, convertendo um sinal NB em um sinal WB, isto é, \textcolor{red}{estimando} as propriedades acústicas pertinentes a WB~\cite{EnioSBrT2013},~\cite{Bauer2014}.
...
\section{\textcolor{red}{\textit{Estratégia}} NSR usando ASR com ABWE}
\label{FrameworkASRABWE}
No cenário de telefonia, sistemas NSR são adequados à utilização dos recusrsos computacionais de um servidor remoto. Assim, \textcolor{red}{técnicas} de processamento digital de sinais, \textcolor{red}{tal como} o realce da fala, podem ser melhor exploradas. Nesse contexto, este artigo propõe  \textcolor{blue}{uma estratégia} em que o sinal NB \textcolor{red}{$s_{NB}$}, fornecido pela PSTN, é realçado através de procedimentos de ABWE, gerando assim um sinal WB sintético \textcolor{red}{$\hat{s}_{WB}$} na entrada do ASR, como ilustrado na Fig.~\ref{FigSistemaNSR}.
%\begin{figure*}
%  \centering
%   \includegraphics[scale=0.25]{figures/nsr02.eps}
%  \centering
...
\begin{itemize}
\item Comprimento do \textit{fame} \textcolor{blue}{igual} a $20$ ms com sobreposição de $10$ ms.
...
\item MAs baseados em HMMs contínuas de 5 estados e topologia esquerda-direita, constituídas por modelos trifônicos \textit{cross-word} \textcolor{red}{desenvolvidos/computados} a partir de 38 monofones.
