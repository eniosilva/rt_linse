...
\label{backgroundASR}
\textcolor{blue}{O objetivo de um sistema de ASR é estimar satisfatoriamente as informações contidas em um sinal de fala. Geralmente o procedimento intermediário desse sistema é a conversão do sinal de fala em texto. Esta seção apresenta uma breve introdução a \textcolor{red}{sistemas} de ASR.}
