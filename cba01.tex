...
%\end{figure}
Dessa forma, as $B$ bandas de frequência representam uma importante etapa para a construção bem sucedida de descritores discriminativos que compõem os vetores de observação MFCCs. Assim, a resolução dos compenentes espectrais, ou seja, a resolução em frequecia é diretamente proporcional a qualidade dos descritores MFCCs. Então, por apresentarem uma maior faixa de frequência, sinais WB possuem uma quantidade maior de descritores na análise MFCC quando comparados à sinais NB. Entretanto, sinais NB podem ser aprimorados através do sistema de ABWE que possibilita a estimação e sí1nteze de novos componentes de frequência capazes de ampliar a resolução do espectro e preencher mais filtros triangulares dispostos na escala mel. A Figura~\ref{FigBancoFiltro} ilustra o processo de distribuição dos espectros NB e WB nos filtros triangulares correspondentes as $B$ bandas de frequencia.
